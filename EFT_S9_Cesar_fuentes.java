...
public class EFT_S9_Cesar_fuentes {
    ...
    public static void main(String[] args) {
     Scanner teclado = new Scanner (System.in);
      ...
      //recolección de información personal y diferenciadora de la persona que compra la entrada.
        ...
        EFT_S9_Cesar_fuentes miLista = new EFT_S9_Cesar_fuentes();
    ...
    try{    
            ...
            teclado.nextLine();
            System.out.println("Ingrese una opcion numerica del 1  al 4");
     }
            ...
            switch (opcion){
                ...
                System.out.println("Muchas gracias por su visita a la pagina web del Teatro Moro");
    ...
    try{   
        ...
        teclado.nextLine();
        System.out.println("Ingrese una opcion numerica del 1  al 5");
    }
